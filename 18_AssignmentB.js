...
console.log(`---------------------------------Step 1------------------------------------------------------------------`);
console.log(`\nthe list of all employee salary and log the new array on console`);
const empSalary=arrayStudents.map((element) =>{
    return element.emp_salary;
});
console.log(`All Emp Salary is: ${empSalary}`);

console.log(`\n---------------------------------Step 2------------------------------------------------------------------`);
console.log(`\nGet the list of departments & log on console`);
const empdepartment=arrayStudents.map((element) =>{
    return element.emp_dept;
})
console.log(`All the department list is: ${empdepartment}`);

console.log(`\n---------------------------------Step 3------------------------------------------------------------------`);
console.log(`\nGet the list of employee id's and log on console`);
const empId=arrayStudents.map((element)=>{
