...
//Write a arrow function with input value "Javascript" and will return the total number of characters
const totalCharCount = (str) => {
    return str.length;
}

const totalChar=totalCharCount("JavaScript");
console.log(`total number of character at given string is: ${totalChar}`);
